                        ...
                        {account ?
                            <React.Fragment>
                                <Tooltip title="Account settings">
                                    ...
                                    >
                                        <Avatar className="avatar" style={{background: "black", color:"rgb(238, 234, 135)"}}>{account.fname[0].toUpperCase()} </Avatar> </IconButton> </Tooltip>
                                <Menu
                                    anchorEl={anchorEl}
                                    id="account-menu"
                                    open={open}
                            ...
                            : <React.Fragment>
                                <Tooltip title="Account settings">
                                    <IconButton className='design'
                                        ...
                                        aria-controls={open ? 'account-menu' : undefined}
                                        aria-haspopup="true"
                                        aria-expanded={open ? 'true' : undefined}><Avatar className='avatar'style={{background: "black"}}></Avatar></IconButton> </Tooltip>
                                    <Menu
                                        anchorEl={anchorEl}
                                        id="account-menu"
                                        open={open}
